...
import saveTheChunkFile from '@salesforce/apex/FileUploadService.saveTheChunkFile2';
import { ShowToastEvent } from 'lightning/platformShowToastEvent';

const MAX_FILE_SIZE = 7500;
const CHUNK_SIZE = 3500;
export default class UploadFile2 extends LightningElement {
    @api recordId;
    ...
    formatBytes(bytes,decimals) {
        ...
        var k = 1024,
            dm = decimals || 2,
            sizes = ['Bytes', 'KB', 'MBB', 'G', 'TB', 'PB', 'EB', 'ZB', 'YB'],
